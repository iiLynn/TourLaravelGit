...
<body>
    ...
    <div class="hero">
        ...
        <div class="text-container">
            ...
            <p>Nuestra agencia de viajes está lista para ofrecerte unas vacaciones emocionantes diseñadas para ajustarse a tus necesidades y deseos. Ya sea un crucero exótico o un viaje a tu resort favorito, seguro tendrás la mejor experiencia.</p>
            <a href="#" class="btn btn-search">Saber Más</a>
        </div>
            ...
            <form>
                <div class="mb-3">
                    ...
                    <select class="form-select" id="from">
                        <option value="all">Usulutan</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label for="to" class="form-label">Lugar</label>
                ...
                <button type="submit" class="btn btn-warning w-100">Buscar Vuelo</button>
            </form>
        </div>
    </div>
...
<div class="container">
    ...
    <div class="tour-card">
        ...
        <a href="{{ route('tours.show', $tour->id) }}" class="btn btn-primary">Ver Detalles</a>
    </div>
    @endforeach
</div>
